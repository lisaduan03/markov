...
class Markov_seven_sys_five_env:
    ...
    sys_probabilities = [[None, None, None, None, None, None, None] \
    ...
    def calculate_probs(self):
        ...
        for t in range(time_steps): #  gives us number of time steps
            for e in range(n): # gives us number of ensembles
                if list_of_env_sys_tuples[e][1][t] == 1:
                    ...
                    if list_of_env_sys_tuples[e][0][t] == 1:
                        ...
                        e_4 = e_4 + 1 
                        e_count = e_count + 1
                elif list_of_env_sys_tuples[e][1][t] == 5: 
                    ...
                    if list_of_env_sys_tuples[e][0][t] == 1:
                        ...
                        e_5 = e_5 + 1 
                        e_count = e_count + 1
                elif list_of_env_sys_tuples[e][1][t] == 6:
                    state_6_count = state_6_count + 1
                    if list_of_env_sys_tuples[e][0][t] == 1:
                        a_6 = a_6 + 1
                        a_count = a_count + 1 
                    elif list_of_env_sys_tuples[e][0][t] == 2:
            ...
            prob_array = [[None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None]]
            ...
            prob_array[5][0] = a_6/n
            prob_array[5][1] = b_6/n
            prob_array[5][2] = c_6/n
            prob_array[5][3] = d_6/n  
            prob_array[5][4] = e_6/n  
            prob_array[6][0] = a_7/n
            prob_array[6][1] = b_7/n
            prob_array[6][2] = c_7/n
            prob_array[6][3] = d_7/n  
            prob_array[6][4] = e_7/n                    
            ...
            self.sys_probabilities[t][5] = state_6_count/n
            self.sys_probabilities[t][6] = state_7_count/n
    ...
    def I_pred_one_step(self):
        ...
        for t in range(len(self.list_of_joint_probs_pred_one_step)):
            ...
            p_a_6 = self.list_of_joint_probs_pred_one_step[t][5][0]
            p_a_7 = self.list_of_joint_probs_pred_one_step[t][6][0]
            ...
            p_b_6 = self.list_of_joint_probs_pred_one_step[t][5][1]
            p_b_7 = self.list_of_joint_probs_pred_one_step[t][6][1]
            ...
            p_c_6 = self.list_of_joint_probs_pred_one_step[t][5][2]
            p_c_7 = self.list_of_joint_probs_pred_one_step[t][6][2]
            ...
            p_d_6 = self.list_of_joint_probs_pred_one_step[t][5][3]
            p_d_7 = self.list_of_joint_probs_pred_one_step[t][6][3]
            ...
            p_e_6 = self.list_of_joint_probs_pred_one_step[t][5][4]
            p_e_7 = self.list_of_joint_probs_pred_one_step[t][6][4]
            ...
            p_6 = self.sys_probabilities[t][5]
            p_7 = self.sys_probabilities[t][6]
            ...
            if p_a_6 != 0 and p_a != 0 and p_6 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_a_6, mp.log(p_a_6 / mp.fmul(p_a, p_6))))
            if p_a_7 != 0 and p_a != 0 and p_7 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_a_7, mp.log(p_a_7 / mp.fmul(p_a, p_7))))
            ...
            if p_b_6 != 0 and p_b != 0 and p_6 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_b_6, mp.log(p_b_6 / mp.fmul(p_b, p_6))))
            if p_b_7 != 0 and p_b != 0 and p_7 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_b_7, mp.log(p_b_7 / mp.fmul(p_b, p_7))))
            ...
            if p_c_6 != 0 and p_c != 0 and p_6 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_c_6, mp.log(p_c_6 / mp.fmul(p_c, p_6))))
            if p_c_7 != 0 and p_c != 0 and p_7 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_c_7, mp.log(p_c_7 / mp.fmul(p_c, p_7))))
            ...
            if p_d_6 != 0 and p_d != 0 and p_6 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_d_6, mp.log(p_d_6 / mp.fmul(p_d, p_6))))
            if p_d_7 != 0 and p_d != 0 and p_7 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_d_7, mp.log(p_d_7 / mp.fmul(p_d, p_7))))
            ...
            if p_e_6 != 0 and p_e != 0 and p_6 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_e_6, mp.log(p_e_6 / mp.fmul(p_e, p_6))))
            if p_e_7 != 0 and p_e != 0 and p_7 != 0:
                I_pred_list_one_step[t] = I_pred_list_one_step[t] + float(mp.fmul(p_e_7, mp.log(p_e_7 / mp.fmul(p_e, p_7))))
    ...
    def verify_I_pred_one_step(self, joint_prob: List[np.array], cond_term: np.array ):
        ...
        for t in range(len(self.list_of_joint_probs_pred_one_step)):
            ...
            if joint_prob[t][5][0] and cond_term[t][5] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][5][0]*np.log(cond_term[t][5]/joint_prob[t][5][0])) 
            if joint_prob[t][6][0] and cond_term[t][6] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][6][0]*np.log(cond_term[t][6]/joint_prob[t][6][0])) 
            ...
            if joint_prob[t][5][1] and cond_term[t][5] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][5][1]*np.log(cond_term[t][5]/joint_prob[t][5][1]))
            if joint_prob[t][6][1] and cond_term[t][6] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][6][1]*np.log(cond_term[t][6]/joint_prob[t][6][1]))   
            ...
            if joint_prob[t][5][2] and cond_term[t][5] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][5][2]*np.log(cond_term[t][5]/joint_prob[t][5][2]))  
            if joint_prob[t][6][2] and cond_term[t][6] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][6][2]*np.log(cond_term[t][6]/joint_prob[t][6][2]))          
            ...
            if joint_prob[t][5][3] and cond_term[t][5] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][5][3]*np.log(cond_term[t][5]/joint_prob[t][5][3]))  
            if joint_prob[t][6][3] and cond_term[t][6] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][6][3]*np.log(cond_term[t][6]/joint_prob[t][6][3]))   
            ...
            if joint_prob[t][5][4] and cond_term[t][5] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][5][4]*np.log(cond_term[t][5]/joint_prob[t][5][4]))  
            if joint_prob[t][6][4] and cond_term[t][6] != 0:
                self.h_xs_verify[t] = self.h_xs_verify[t] + (joint_prob[t][6][4]*np.log(cond_term[t][6]/joint_prob[t][6][4])) 
...
test_1 = Markov_seven_sys_five_env(np.array([[.025, .9, .025, .025, .025], [.025, .025, .9, .025, .025], [.025, .025, .025, .9, .025], [.025, .025, .025, .025, .9], [.9, .025, .025, .025, .025]]), \
