...
class Markov_three_sys_five_env:
    ...
    def calculate_probs(self):
        ...
        for t in range(time_steps): #  gives us number of time steps
            ...
            prob_array = [[None, None, None, None, None], [None, None, None, None, None], [None, None, None, None, None]]
...
test_1 = Markov_three_sys_five_env(np.array([[.025, .9, .025, .025, .025], [.025, .025, .9, .025, .025], [.025, .025, .025, .9, .025], [.025, .025, .025, .025, .9], [.9, .025, .025, .025, .025]]), \
    np.array([[.9, .05, .05], [.9, .05, .05], [.9, .05, .05]]), np.array([[.9, .05, .05], [.9, .05, .05], [.9, .05, .05]]), \
