        ...
        for i in range(1):            
            ...
            while s < number_of_sims:
                ...
                for sys_size in range (2, 11):
                    trajectory = Markov_flex_sys_flex_env(randomly_generated_env_size_x[i], generate_random_matrix(sys_size), generate_random_matrix(sys_size), p_t3= generate_random_matrix(sys_size), p_t4= generate_random_matrix(sys_size), p_t5= generate_random_matrix(sys_size))
                    trajectory.generate_ensemble(10000)
                    trajectory.calculate_probs()
...
file_name = "8_3_5_state_set_1" + sys.argv[1] + ".csv"
func(10000, 5, file_name)