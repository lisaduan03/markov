...
"""
IMPORTANT: environment size is 5. 10:30 am- just practice right now with 2 sims,
 once it works run with 1000
"""


def set_1_env_5(number_of_sims: int, env_size: int, file_name: str):
    """
    for set 1: 
        Broken DB
        weak coupling
...
set_1_env_5(2, 5, "practice_set_1_env_size_5_1.csv")
print("hi")
